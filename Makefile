...
CXXFLAGS = -std=c++11 $(WFLAGS) -I $(SRC_DIR) -I $(GSLLIBROOT)/include -march=native -Ofast -fprofile-use -fopenmp -D_GLIBCXX_PARALLEL

LDFLAGS = -L$(GSLLIBDIR) -L. -Wl,-rpath=$(GSLLIBDIR) -lGSLpp -lxc -lm -lgsl -Ofast -flto -fprofile-use -fopenmp -D_GLIBCXX_PARALLEL
